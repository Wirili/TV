...
public class AppYsV2 extends Spider {
    ...
    public JSONObject fixJsonVodHeader(JSONObject headers, String input, String url) throws JSONException {
        if (headers == null)
    ...
    public JSONObject jsonParse(String input, String json) throws JSONException {
